        ...
        <aside class="left-sidebar bg-sidebar">
          <div id="sidebar" class="sidebar sidebar-with-footer">
            ...
            <div class="app-brand" style="background-color:#B0C4DE" >
              <a href="admin.php" title="NCYU CSIE Dashboard">
                <!--<svg-->
                <!--  class="brand-icon"-->
            ...
            <div class="col-xs-12">
                <form id="article">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" aria-describedby="emailHelp" placeholder="輸入標題" style="width: 900px;" value="<?php echo $data['title'];?>">
